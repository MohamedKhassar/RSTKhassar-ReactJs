...
const Slogan = () => {
    ...
    return (
        <div className="h-screen bg-no-repeat bg-cover bg-center flex flex-col justify-center items-center space-y-20" id="home" style={{ backgroundImage: `url(${plate_bg})` }}>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: .5, ease: "easeIn" }} className="flex lg:justify-between justify-center items-end w-full h-fit mb-14 px-10">
                <div className="space-y-5">
                    <div className="bg-[#FDD78C] text-[#694909] rounded-md lg:px-5 lg:py-3 flex gap-x-5 justify-between lg:text-2xl text-lg items-center font-Montserrat font-semibold cursor-pointer p-3">
                        <h1 className="">{dayNames[day]}</h1>
                        <p>09:00-22:00</p>
                    </div>
                    <div className="duration-300 gap-x-5 hover:text-[#FDD78C] hover:bg-[#694909] border-2 hover:border-[#694909] lg:text-[#694909] text-[#FDD78C] border-[#FDD78C] cursor-pointer rounded-md lg:px-5 lg:py-3 flex justify-between lg:text-2xl text-lg p-3 items-center font-Montserrat font-semibold">
